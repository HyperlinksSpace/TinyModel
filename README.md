...
| **Embedded prompt signals** | Long “normal chat” lines can **imply** one-turn overlays: tradeoffs, tables, steps, reply language, code-only, length caps, guided discovery, red-team, ephemeral, a11y, beginner audience, register, JSON, strict speculation, BLUF, runnable commands, assumptions, example density, exposition order, follow-up closing, clarify-first, section headings, analogies — see **`prompt_signals:`** in the *Brain trace* and the Space UI section **Testing embedded prompt signals**. |
