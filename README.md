...
- **Live web search (roadmap; not in the Space yet)** — To add **internet-grounded** answers you typically call a **search API** or a **self-hosted metasearch** layer, then inject snippets like FAQ RAG. **Hosted APIs (verify current pricing):** [Tavily](https://www.tavily.com/pricing) (~1k API credits/mo on the free Researcher tier), [SerpApi](https://serpapi.com/pricing) (~100 searches/mo free), [Exa](https://exa.ai/pricing) (~1k requests/mo free tier—confirm), [Brave Search API](https://api.brave.com/) (metered; ~$5/1k-style web tiers—check the [plans dashboard](https://api-dashboard.search.brave.com/app/plans)), [Bing Web Search](https://learn.microsoft.com/en-us/bing/search-apis/bing-web-search/overview) via Microsoft/Azure ([pricing](https://www.microsoft.com/en-us/bing/apis/pricing); small free allowance may apply on some SKUs). **[Google Custom Search JSON API](https://developers.google.com/custom-search/v1/overview)** is **closed to new customers**; remaining users must migrate before **2027-01-01**. **Open source / no per-query vendor fee (you still run servers and must respect upstream ToS):** [SearXNG](https://github.com/searxng/searxng) (AGPL-3.0 metasearch), [YaCy](https://github.com/yacy/yacy_search_server) (GPL crawler mesh), plus **Wikipedia / Wikidata** HTTP APIs, **RSS/Atom** allowlists, and **Common Crawl** for offline/batch use—not live “headlines today.” **Avoid** automating consumer search HTML (e.g. DuckDuckGo/Whoogle-style scraping) for production without legal review. **Full comparison table, links, and integration notes:** [`texts/plan-internet-access-for-universal-brain.md`](texts/plan-internet-access-for-universal-brain.md) (section **4**).
