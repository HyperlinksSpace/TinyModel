...
Maintainer deployment policy: [`texts/HUGGING_FACE_DEPLOYMENT_INTERNAL.md`](texts/HUGGING_FACE_DEPLOYMENT_INTERNAL.md). Capability reference for the Space: [`texts/universal-brain-capabilities.md`](texts/universal-brain-capabilities.md). Research synthesis (text-in / text-out stack): [`texts/tinymodel-text-in-text-out-research.md`](texts/tinymodel-text-in-text-out-research.md). Universal Brain concept vs TinyModel today: [`texts/universal-brain-concept-vs-tinymodel-today.md`](texts/universal-brain-concept-vs-tinymodel-today.md). Forward plan (universal capability, tokens, self-development): [`texts/universal-brain-forward-plan-self-development.md`](texts/universal-brain-forward-plan-self-development.md). Golden prompts + eval runner: [`texts/golden-prompts/README.md`](texts/golden-prompts/README.md) · `python scripts/ub_eval_runner.py --verify`.
