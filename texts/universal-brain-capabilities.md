...
| **Decisions** | `ranked_options`, `decision_matrix`, `build_vs_buy`, `one_pager`, `status_report`, `raci`, `stakeholder_map`, `cost_benefit`, `recommendation_first`, `go_no_go`, `options_n=3`, `checklist`, `no_checklist` |
| **Visual & structure** | `diagram`, `no_diagram`, `frame_star`, `frame_prep`, `frame_irac`, `swot`, `pestle`, `timeline_chron`, `timeline_reverse` |
| **Planning & editing** | `action_plan`, `risks_first`, `benefits_first`, `risks_mitigations`, `revise_draft`, `revise_diff`, `email_format`, `letter_format`, `press_release`, `release_notes`, `runbook_format`, `job_aid`, `meeting_agenda`, `topic_guard`, `topic_must`, `glossary`, `open_questions`, `scenario_cases`, `postmortem`, `sprint_retro`, `user_story`, `definition_of_done`, `five_whys`, `fishbone` |
